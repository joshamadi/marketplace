        ...
        <div className="flex items-center justify-between">
          <label className="flex items-center gap-2 cursor-pointer">
            <input
              ...
              className="h-4 w-4 rounded border-gray-300 text-[#E23E3E] focus:ring-[#E23E3E] cursor-pointer"
            />
          ...
          <button
            type="button"
            className="text-sm font-medium text-[#E23E3E] hover:underline"
          >
            Forgot password?
          </button>
        </div>
